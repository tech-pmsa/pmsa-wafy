...
// Reusable Components (StatCard, Tooltip)
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col">
                ...
                <div className="grid gap-4 md:grid-cols-3 my-2">
                    ...
                    <div className="relative md:col-span-1"><Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" /><Input placeholder="Search student..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-9" /></div>
                </div>
    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-6">
                <div className="grid gap-4 md:grid-cols-2 overflow-x-hidden lg:grid-cols-3">
